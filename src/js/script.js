...
function startGame() {
    ...
    myObstacle = new component(30, 30, "/assets/img/ninja2.png", 10, 120, "image");
    /*myScore = new component("30px", "Consolas", "black", 40, 40, "text");*/
    myGamePiece = new component(60, 60, "/assets/img/ninja1.png", 10, 400, "image");
...
function updateGameArea() {
    ...
    if (myGameArea.frameNo == 1 || everyinterval(10)) {
        ...
        myObstacles.push(new component(80, 80, "/assets/img/monster4.png", x, height, "image"));
  ...
  if (myGameArea.keys && myGameArea.keys[37]) {myGamePiece.speedX = -3; myGamePiece.image.src = "/assets/img/ninja4.png"}
  if (myGameArea.keys && myGameArea.keys[39]) {myGamePiece.speedX = 3; myGamePiece.image.src = "/assets/img/ninja2.png"}
  if (myGameArea.keys && myGameArea.keys[38]) {myGamePiece.speedY = -3; myGamePiece.image.src = "/assets/img/ninja3.png"}
  if (myGameArea.keys && myGameArea.keys[40]) {myGamePiece.speedY = 3; myGamePiece.image.src = "/assets/img/ninja1.png" }
  ...
  function moveup() {
    myGamePiece.image.src = "/assets/img/ninja2.png";
  ...
  function stopMove() {
    myGamePiece.image.src = "/assets/img/ninja1.png";
    myGamePiece.speedX = 0;
    myGamePiece.speedY = 0;
  }

  function monster (){
    myObstacles.image.src = "/assets/img/ninja1.png";
  }